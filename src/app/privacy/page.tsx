    ...
    >
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px 64px' }}>
        ...
        <Section title="제1조 개인정보의 수집 및 이용 목적">
          ...
          <Table
            ...
            rows={[
              ...
              ['결제 처리', '결제 수단 정보', '포트원(PortOne)이 직접 처리 (당사 미보관)'],
        ...
        <Section title="제2조 수집하는 개인정보 항목">
          ...
          <p>
            결제 처리는 포트원(PortOne)이 담당합니다. 카드번호, 유효기간 등 카드 정보는 당사 서버에
            저장되지 않으며, 포트원(PortOne) 및 결제수단 제공사의 개인정보처리방침이 적용됩니다.
          </p>
        ...
        <Section title="제5조 개인정보 처리의 위탁">
          ...
          <Table
            ...
            rows={[
              ...
              ['포트원(PortOne)', '결제 대행', '서비스 운영 기간 또는 위탁 계약 종료 시'],
            ]}
          />
          <p style={{ marginTop: 12, fontSize: 13, color: '#575654' }}>
